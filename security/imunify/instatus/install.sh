...
RAW_BASE="https://raw.githubusercontent.com/rubix-studios-pty-ltd/whm-scripts/main/security/imunify/instatus"
SCRIPT_URL="$RAW_BASE/status.sh"

INSTALL_PATH="/usr/local/sbin/rubix-imunify-instatus"
