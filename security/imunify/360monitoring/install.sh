...
RAW_BASE="https://raw.githubusercontent.com/rubix-studios-pty-ltd/whm-scripts/main/security/imunify/360monitoring"
SCRIPT_URL="$RAW_BASE/status.sh"

INSTALL_PATH="/usr/local/sbin/rubix-imunify-360monitoring"
CRON_PATH="/etc/cron.d/rubix-imunify-360monitoring"
LOG_PATH="/var/log/rubix-imunify-360monitoring.log"
