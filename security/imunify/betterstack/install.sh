...
RAW_BASE="https://raw.githubusercontent.com/rubix-studios-pty-ltd/whm-scripts/main/security/imunify/betterstack"
INSTALL_PATH="/usr/local/sbin/rubix-imunify-betterstack"
